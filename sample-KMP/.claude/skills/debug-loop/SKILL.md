---
name: "debug-loop"
description: "Five-step root-cause triage — reproduce, localize, reduce, fix, guard — for Session 3 (`/kit-fix`) defects whose source line is not obvious."
---
<skill name="debug-loop">
